...
function faq() {
  return (
    <Layout>
      <Menu />
      <h2 className="flex gap-3 text-4xl font-bold px-20 py-10 text-sky-500">
        {" "}
        <BsQuestionSquare />
        FAQ
      </h2>

      <div className="px-20 py-5 flex flex-col gap-5 max-w-7xl">
        <div className="bg-slate-800 px-2 py-2 rounded shadow shadow-white">
          ...
          <p>Los gastos de envío y manipulación se calcularán automáticamente y se añadirán a su pedido en función del peso total del mismo. Tendrá la oportunidad de revisar la estimación final de los gastos de envío y manipulación antes de finalizar el pedido.</p>
        </div>
        <div className="bg-slate-800 px-2 py-2 rounded shadow shadow-white">
